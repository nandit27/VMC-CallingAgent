...
const Footer = () => {
    return (
        <footer className="mt-auto bg-slate-900 text-white pt-16 pb-8 border-t border-slate-800" style={{ fontFamily: 'Poppins, sans-serif' }}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-4 mt-6">
                            <a href="#" className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center hover:bg-blue-600 transition-all">
                                <Twitter size={16} />
                            </a>
                            <a href="#" className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center hover:bg-blue-600 transition-all">
                                <Facebook size={16} />
                    ...
                    <div className="md:text-right">
                        <h4 className="text-lg font-semibold mb-6 text-slate-200">Contact Us</h4>
                        <div className="flex flex-col md:items-end space-y-4 text-sm text-slate-400">
                            ...
                            <div className="flex items-center gap-3 md:flex-row-reverse">
                                ...
                                <span>1800-233-0265 <span className="text-xs text-slate-600">(Toll Free)</span></span>
                            </div>
                            <div className="flex items-center gap-3 md:flex-row-reverse">
